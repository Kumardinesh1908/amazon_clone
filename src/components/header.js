...
import { logo, location, shopping } from "../assets/index";
...
export default function Header() {
    ...
    return (
        <div>
            <div className="w-full bg-amazon_black text-white px-3 py-2 flex items-center gap-3">
                ...
                <div className="h-10 rounded-md flex flex-grow relative">
                    ...
                    <input
                        className="h-full text-base text-amazon_black flex-grow  px-2 border-none outline-none   placeholder:text-[#111111] font-[400]"
                        type="text" placeholder="Search Amazon.in"
                    />
                    <span className="w-12 h-full flex items-center justify-center bg-amazon_yellow hover:bg-[#f3a847] text-amazon_black cursor-pointer rounded-tr-md rounded-br-md duration-300">
                        <SearchIcon />
                    </span>
                </div>
                {/* Search ends here */}
                ...
                <div className="headerHover">
                    <img className="w-5" src="https://cdn-icons-png.flaticon.com/128/6211/6211446.png" alt="india" />
